...
// print(pushUp)
var squats = Exercise(name: "Squats", muscleGroups: ["Gluteus", "Quadriceps femoris"], reps: 10, sets: 3)
...
var tuesdayRegimen = Regimen(dayOfWeek: "Tuesdat", exercises: [squats])

mondayRegimen.addExercises([squats])
print(mondayRegimen)
